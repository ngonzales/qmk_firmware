...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_QW] = { /* QWERTY */
  ...
  { KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC, KC_P4,   KC_P5,   KC_P6   },
  { KC_GRAVE, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,  KC_P1,   KC_P2,   KC_P3   },
  { KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,  KC_P0,   KC_UP,   KC_PDOT },
  { KC_LCTL, MO(_FN), KC_LGUI, KC_LALT, MO(_LW), KC_SPC,  MO(_GHERKIN),  MO(_UP),  KC_RALT, KC_RALT, MO(_TEST), MO(_MS), KC_LEFT, KC_DOWN, KC_RGHT },
 },      


 [_FN] = { /* FUNCTION */
  { _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, _______ , _______,   },
  { _______, KC_MSEL, KC_BTN1, KC_MS_U, KC_BTN2, RGB_HUD, RGB_HUI, KC_EQL,  KC_PLUS, KC_LCBR, KC_RCBR, KC_BSLS, KC_CAPS, KC_NLCK, KC_SLCK  },
  { _______, KC_LEFT, KC_MS_L, KC_MS_D, KC_MS_R, RGB_SAD, RGB_SAI, KC_MINS, KC_DQUO, KC_LBRC, KC_RBRC, _______, KC_PSCR, KC_INS, _______   },
  { KC_VOLD, KC_MUTE, KC_VOLU, KC_APP,  RGB_VAD, RGB_VAI, KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______, _______, _______, KC_VOLU, _______  },
  { _______, _______, _______, RGB_TOG, _______, RGB_MOD, KC_P0,   _______, KC_PDOT, KC_PENT, KC_PENT, _______, _______, KC_VOLD, RESET  },
 },
...
[_UP] = { /* FUNCTION */
  { _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   },
  { _______, _______, _______, KC_AMPR, KC_PIPE, _______, _______, KC_DQUO, KC_QUOT, KC_GRAVE, _______, _______, _______, _______, _______, },
  { _______, _______, _______, KC_EQUAL,KC_RABK, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, },
  { _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, },
  { _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,},
 },
 ...
 [_LW] = { /* FUNCTION */
  { _______,     KC_F1,   KC_F2,   KC_F3,   ALTF4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_LPRN, KC_RPRN, _______,  _______, _______, _______,   },
  {LALT(KC_TAB), _______, _______, KC_UP,   _______, _______, KC_EQL,  KC_PLUS, KC_MINS, KC_LCBR, KC_RCBR, _______,  _______, _______, _______  },
  { _______,     KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  KC_EQL,  KC_ASTR, KC_PSLS, KC_LBRC, KC_RBRC, KC_DQUO,  _______, _______, _______   },
  { _______,     _______, _______, _______, _______, _______, _______, KC_UNDS, KC_LABK, KC_RABK, KC_PSLS, KC_BSLS,  _______, _______, _______  },
  { _______,     _______, _______, RGB_TOG, _______, RGB_MOD, KC_LCTL, KC_LSFT, KC_PDOT, KC_AMPR, KC_PIPE, KC_GRAVE, _______, _______, _______ },
 }
};
